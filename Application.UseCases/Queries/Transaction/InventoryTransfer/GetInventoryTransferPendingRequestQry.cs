...
public record GetInventoryTransferPendingRequestQry(int DocEntry) : IRequest<InventoryTransferHeaderDTO?>;
public class GetPendingInventoryTransferRequestQryHandler(
        IInventoryTransferIntegration inventoryTransferIntegration
    ) : IRequestHandler<GetInventoryTransferPendingRequestQry, InventoryTransferHeaderDTO?>
{
    public async Task<InventoryTransferHeaderDTO?> Handle(GetInventoryTransferPendingRequestQry request, CancellationToken cancellationToken)
    {

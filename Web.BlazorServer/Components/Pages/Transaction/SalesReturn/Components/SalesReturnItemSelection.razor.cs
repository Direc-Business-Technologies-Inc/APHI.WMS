...
public partial class SalesReturnItemSelection
{
    ...
    [Parameter] public required SalesReturnVM Return { get; set; } = default!;
    [Parameter] public EventCallback<SalesReturnVM> ReturnChanged { get; set; } = default!;
    ...
    async Task OnRowSelect(ItemVM data)
    {
        ...
        {
            Return.DocumentLines.Add(new SalesReturnLineVM
            {

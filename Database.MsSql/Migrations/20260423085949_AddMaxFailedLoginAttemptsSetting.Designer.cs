...
namespace Database.MsSql.Migrations
{
    ...
    [Migration("20260423085949_AddMaxFailedLoginAttemptsSetting")]
    partial class AddMaxFailedLoginAttemptsSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Entities.System.SettingsDEM", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Number of consecutive failed login attempts before the user account is locked. Must be a positive integer. Defaults to 5 if not configured.",
